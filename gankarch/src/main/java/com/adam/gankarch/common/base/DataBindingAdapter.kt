 ...
 */
abstract class DataBindingAdapterForMulty<T : MultiItemEntity>(data: List<T>?)
...
abstract class DataBindingAdapter<T : MultiItemEntity>(layoutResId: Int, data: List<T>?)
    : BaseQuickAdapter<T, DatabindingViewHolder>(layoutResId, data) {
