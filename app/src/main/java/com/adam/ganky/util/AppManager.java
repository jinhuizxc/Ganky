...
public class AppManager {
    ...
    public static boolean jump(Class<? extends Activity> clazz) {
        return jump(clazz, null, null);
    }

    public static boolean jump(Class<? extends Activity> clazz, String key, Object value) {
        if (isForground) {
            ...
            if (!TextUtils.isEmpty(key) && value != null) {
                if (value instanceof Bundle) {
                    ...
                    throw new IllegalArgumentException("can not support the value type : " + value.getClass());
                }
            }
